[Setup]
AppName=Golf It by StormGamesStudios
AppVersion=1.0.5
DefaultDirName={userappdata}\StormGamesStudios\NewGameDir\GolfItGame
DefaultGroupName=StormGamesStudios
OutputDir=C:\Users\melio\Documents\GitHub\GolfItGame\output
OutputBaseFilename=GolfIt_Launcher_Installer
Compression=lzma
...
[Run]
Filename: "{app}\installer_updater.exe"; Description: "Ejecutar Golf It"; Flags: nowait postinstall skipifsilent
...
begin
  ...
  RunUninstaller(ExpandConstant('{userappdata}\StormGamesStudios\NewGameDir\Golf It'));
