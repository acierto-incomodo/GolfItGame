...
REPLACEMENTS = {
    "{NAME}": "Golf It",       # Nombre visible del juego
    "{ID}": "golfit",         # ID usado en rutas/carpetas (sin espacios)
    "{REMOVE}": "GolfIt",  # Nombre del ejecutable/proceso a cerrar
    "{GITHUB}": "GolfItGame",
    "{OLDREMOVE}": "GolfItGame",
    "{OLDDIR}": "GolfItGame",
}
