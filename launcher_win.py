...
BASE_URL_WIN = "https://github.com/acierto-incomodo/GolfItGame/releases/latest/download/Build.zip"
BUILD_URL_LINUX = "https://github.com/acierto-incomodo/GolfItGame/releases/latest/download/Build.zip"
VERSION_URL = "https://github.com/acierto-incomodo/GolfItGame/releases/latest/download/version.txt"
...
EXE_NAME_WIN   = "Build/GolfItLauncher.exe"
EXE_NAME_LINUX = "Build/GolfItLauncher.exe"
...
class LauncherWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Golf It - Launcher")
    ...
    def setup_ui(self):
        ...
        title = QtWidgets.QLabel("Golf It")
